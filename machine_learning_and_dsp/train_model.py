...
def train_model(list_of_dirs, mtStep=0.4, mtWin=0.4, stStep=0.04, stWin=0.04, classifierType='svm',
                modelName='test_model_file',
                useBeatmap=False):
